		...
		<td>
            <div style="display:none;" id="category_remove">
                <div id="categ_remove_%s" class="margin-form">
                    ...
                    <a href="javascript:removeContent(%s);" title="Ajouter un categorie" class="ajoutCategorie" rel="categorie"><i class="process-icon-delete"></i></a>
                </div>
            </div>
        	<div class="categorie" id="ajoutSupprimerCategorie">
                <div>
                    ...
                    <a href="javascript:addContent();" title="Ajouter un categorie" class="ajoutCategorie" rel="categorie"><i class="process-icon-new"></i></a>
                </div>
                ...
                <input type="text" name="Categorie[]" class="titre" id="categValue_%s" value="{$category.column}"/>
                    <a href="javascript:removeContent({$catkey});" title="Ajouter un categorie" class="ajoutCategorie" rel="categorie"><i class="process-icon-delete"></i></a>
                </div>
                {/foreach}
